...
\begin{align*}
ln\mathcal{Q}(H(r)|H(k))^{-2/T}&=ln\left(\frac{|\hat{S}_{0,0}|\prod_{i=1}^r (1-\hat{\lambda_i})}{|\hat{S}_{0,0}|\prod_{i=1}^k(1-\hat{\lambda_i})}\right)\\
    ln\mathcal{Q}(H(r)|H(k))^{-2/T}&=ln\left(|\hat{S}_{0,0}| \sum_{i=1}^r (1-\hat{\lambda_i})\right)-ln\left(|\hat{S}_{0,0}|\sum_{i=1}^k (1-\hat{\lambda_i})\right)\\
    -2ln\mathcal{Q}(H(r)|H(k))^{-2/T}&=-2\left( ln\left(|\hat{S}_{0,0}| \sum_{i=1}^r (1-\hat{\lambda_i})\right)-ln\left(|\hat{S}_{0,0}|\sum_{i=1}^k (1-\hat{\lambda_i})\right)\right)\\
    -2ln\mathcal{Q}(H(r)|H(k))^{-2/T}&=-2\sum_{i=r+1}^k(1-\hat{\lambda}_i)
\end{align*}
